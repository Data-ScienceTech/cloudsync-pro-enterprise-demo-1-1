      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-rose-400">
              <li>
        ...
        <div className="border-t border-rose-800 mt-8 pt-8 text-center text-rose-400">
          ...
          <p className="text-sm mt-1">
            ...
            <Link to="/privacy-policy" className="text-rose-400 hover:text-rose-300 transition-colors">
              privacy policy
            </Link>
            {' '}and{' '}
