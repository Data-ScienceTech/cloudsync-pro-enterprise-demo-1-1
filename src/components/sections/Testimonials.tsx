        ...
        <div className="relative max-w-4xl mx-auto">
          <Card className="shadow-lg">
            <CardContent className="p-8 md:p-12 text-center">
              <div className="mb-8">
                <blockquote className="text-xl md:text-2xl text-rose-700 leading-relaxed mb-8">
                  "{t(`testimonials.testimonial${currentIndex + 1}.text`)}"
                </blockquote>
                <div>
                  <div className="font-semibold text-rose-900 text-lg">
              ...
              {Array.from({ length: totalTestimonials }).map((_, index) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full transition-colors ${
                    index === currentIndex ? 'bg-rose-600' : 'bg-rose-300'
                  }`}
                />
              ))}
            </div>
